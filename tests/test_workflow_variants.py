...
def test_variants_do_not_change_public_surface_counts():
    ...
    assert len(tool_names) == 164  # Three durable intent/recipe surfaces were added after 1.11.1.
...
def test_variant_flags_do_not_add_cli_commands():
    ...
    assert len(set(command_list.split(","))) == 140  # Variants add none; sound adapters add six.
