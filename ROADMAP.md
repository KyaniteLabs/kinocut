...
Kinocut 1.15.2 is published with 201 MCP tools and 173 CLI commands (`mcp-video` 1.6.13 shim).

**Published product:** Kinocut **1.15.2** (2026-09-24) · **201 MCP / 173 CLI** · living snapshot [`docs/status/NOW.md`](docs/status/NOW.md)
...
This file is **planning truth for after 1.15.2**. July 2026 status notes and pre-1.3 history live under **Archive** — they are evidence, not current claims. Prefer the **2026-08-12 residual matrix** over any July “S5–S15 incomplete / missing packages” language.
...
Product phases 1–4 + Track E are **GO** on tip (1.15.2). Agents must not invent third-party directory approvals. Do **not** re-open #92 as incomplete.
