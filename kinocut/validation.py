...
OBJECT_MATTE_MAX_DOWNLOAD_BYTES = 1_073_741_824
OBJECT_MATTE_WEIGHTS_MAX_BYTES = OBJECT_MATTE_MAX_DOWNLOAD_BYTES
OBJECT_MATTE_INPUT_SIZE = 1024
OBJECT_MATTE_ALPHA_SUFFIXES = frozenset({".webm", ".mov", ".png"})
