...
- Description: Guardrailed video editing for AI agents with FFmpeg, captions,
  ...
  provenance receipts.
- Published surface: 194 MCP tools / 165 CLI commands (1.13.2)
- Development tip: 194 MCP tools / 165 CLI commands (matches published 1.13.2)
- Current release: 1.13.2 (published 2026-08-09)
