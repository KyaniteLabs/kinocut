...
- [Product / object matte](PRODUCT_MATTE.md) - product/catalog cutouts on existing `hyperframes-remove-background --model birefnet-general` (published in 1.15.1 as the optional `kinocut[object-matte]` extra). No new MCP name. Example: [examples/product-matte/](../examples/product-matte/).
