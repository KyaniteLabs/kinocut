...
| DEF-mcpb-sign | mcpb | **PARTIAL** — production checklist + pack builder shipped; **human signing still residual** |
...
| DEF-mcpb-sign | mcpb | Cryptographic multi-platform signing | Human | N product core (unsigned pack + checklist shipped) | Human sign keys | 2026-08-12 |
