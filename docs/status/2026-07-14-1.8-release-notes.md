...
**Later pin (current as of 1.14.1):** `mcp-video==1.6.11` currently pins `kinocut==1.14.1`.
...
3. **Compat** — `mcp-video==1.6.11` currently pins `kinocut==1.14.1`; `mcp_video` imports,
