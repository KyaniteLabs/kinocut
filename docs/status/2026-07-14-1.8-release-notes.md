...
**Later pin (current as of 1.15.1):** `mcp-video==1.6.12` currently pins `kinocut==1.15.1`; staged next, `mcp-video==1.6.13` → `kinocut==1.15.2` with the 1.15.2 release train (not yet published).
