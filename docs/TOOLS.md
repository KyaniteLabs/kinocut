...
| `sound_mix_render` | Assemble supplied WAVs with V2/V3 [routing](SOUND_ROUTING_REQUESTS.md), [automation](SOUND_AUTOMATION_REQUESTS.md), [sends](SOUND_SEND_REQUESTS.md) and [final sidechains](SOUND_SIDECHAIN_REQUESTS.md); V3 adds [layers/loop fill/ducking](SOUND_LAYER_REQUESTS.md). Takes a persisted request and project root. No-argument labelled demo remains available. See [request contract](SOUND_MIX_REQUESTS.md). |
