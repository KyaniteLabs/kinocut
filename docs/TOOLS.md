...
| `sound_mix_render` | Assemble supplied WAVs with source windows, crossfades and additive ducked ambience; V2 adds [static track/bus routing](SOUND_ROUTING_REQUESTS.md). Takes a persisted request and project root. No-argument labelled demo remains available. See [request contract](SOUND_MIX_REQUESTS.md). |
