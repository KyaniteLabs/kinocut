...
| `sound_mix_render` | Assemble supplied WAVs with source windows, crossfades and additive ducked ambience; V2/V3 support [routing](SOUND_ROUTING_REQUESTS.md) and [track automation](SOUND_AUTOMATION_REQUESTS.md), V3 adds [ambient layers, loop fill and layer ducking](SOUND_LAYER_REQUESTS.md). Takes a persisted request and project root. No-argument labelled demo remains available. See [request contract](SOUND_MIX_REQUESTS.md). |
