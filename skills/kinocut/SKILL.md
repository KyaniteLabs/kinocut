...
3. Prefer previews or dry-run manifests before expensive or destructive exports:
   ...
   - For track/bus gain, pan and mute/solo, use mix request version2 with explicit cue-track bindings; see `docs/SOUND_ROUTING_REQUESTS.md`. V2/V3 support absolute global-timeline gain/pan envelopes; see `docs/SOUND_AUTOMATION_REQUESTS.md` and inspect `automation_sha256` plus verified source-window evidence. Unsupported parameters, sends, general sidechains and effects are rejected.
