...
3. Prefer previews or dry-run manifests before expensive or destructive exports:
   ...
   - For static track/bus gain, pan and mute/solo, use mix request version2 with explicit cue-track bindings; see `docs/SOUND_ROUTING_REQUESTS.md`. Inspect the compact routing hash and full archive receipt. Unsupported sends, automation, sidechains and effects are rejected.
